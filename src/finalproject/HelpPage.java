...
public class HelpPage extends JFrame {
    ...
    public HelpPage() {
        setTitle("Help - Hotel Booking App");
        setSize(500, 400);
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src/finalproject/ReadMe.md"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                textArea.append(line + "\n");
            }
        } catch (IOException e) {
            textArea.setText("Gagal membaca file readme.md: " + e.getMessage());
        }
